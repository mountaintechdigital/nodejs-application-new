...
app.get('/landmarktechnologies', function(request, response) {
    ...
    response.write("<h2><center>Welcome to  Sara Technologies. Please Contact +14665859 for more information or send an email to info@mylandmarktech.com <center></h2>" );
    response.end();
